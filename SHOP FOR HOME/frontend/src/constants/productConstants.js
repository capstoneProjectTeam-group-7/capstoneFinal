...
export const BULK_PRODUCT_REQUEST = "BULK_PRODUCT_REQUEST";
export const BULK_PRODUCT_SUCCESS = "BULK_PRODUCT_SUCCESS";
export const BULK_PRODUCT_RESET = "BULK_PRODUCT_RESET";
export const BULK_PRODUCT_FAIL = "BULK_PRODUCT_FAIL";
